...
export class DupesService {
  ...
  async findOne(id: string) {
    ...
    return {
      ...
      original: {
        ...base.original,
        description: dupe.originalProduct.description ?? null,
        size: dupe.originalProduct.size ?? null,
        rawIngredients: dupe.originalProduct.ingredients ?? null,
        ingredientsTokens: dupe.originalProduct.ingredientsTokens ?? [],
        ingredientBreakdown: dupe.originalProduct.ingredientBreakdown ?? null,
        skinTypeSuitability: dupe.originalProduct.skinTypeSuitability ?? null,
        skinTypeRecommendedFor: dupe.originalProduct.skinTypeRecommendedFor ?? [],
        parsedIngredients: parsedOriginal,
      },
      dupe: {
        ...base.dupe,
        description: dupe.dupeProduct.description ?? null,
        size: dupe.dupeProduct.size ?? null,
        rawIngredients: dupe.dupeProduct.ingredients ?? null,
        ingredientsTokens: dupe.dupeProduct.ingredientsTokens ?? [],
        ingredientBreakdown: dupe.dupeProduct.ingredientBreakdown ?? null,
        skinTypeSuitability: dupe.dupeProduct.skinTypeSuitability ?? null,
        skinTypeRecommendedFor: dupe.dupeProduct.skinTypeRecommendedFor ?? [],
